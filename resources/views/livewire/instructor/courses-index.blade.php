<div class="container py-8">
    <x-table-responsive>
        ...
        <div class="py-4 px-6 flex">
            <input wire:keydown="limpiar_page" wire:model="search" type="text" class="focus:ring-indigo-500 focus:border-indigo-500 block flex-1 shadow-sm sm:text-sm border-gray-300 rounded-md" placeholder="Inrese el nombre de un curso">
        ...
        @else
            <div class="px-6 py-4 bg-white text-red-900">
